...
internal fun base32ToBytes(base32: String): ByteArray {
    return base32.trimEnd('=').uppercase()
        ...
        .chunked(8).flatMap { chunk ->
            ...
            listOf( // 00000111 11222223 33334444 45555566 66677777
                ...
                ((block[4] and 0b00001 shl 3) or (block[5] and 0b11111 shl 2) or (block[6] and 0b11000 shr 3)),
